  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Read our latest tech, coding, and career articles."
        />
      </Helmet>
        ...
        <div className="flex flex-col md:flex-row items-center justify-center min-h-screen p-4 bg-[#F0F8FF] dark:bg-gray-950">
          ...
          <div className="hidden md:block w-1/2">
            <img
              src={auth}
              alt="Auth Visual"
              className="w-full h-auto max-h-[720px] object-cover rounded-xl shadow-md"
            />
          </div>
              ...
              <CardContent>
                <form className="space-y-4" onSubmit={handleSubmit}>
                  ...
                  <p className="text-center text-gray-600 dark:text-gray-400">
                    ...
                    <Link
                      to="/signup"
                      className="underline hover:text-[#1E90FF]"
                    >
                      Sign up
                    </Link>
                  </p>
